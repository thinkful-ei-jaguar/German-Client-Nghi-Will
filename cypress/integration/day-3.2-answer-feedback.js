  ...
  context(`Given guess is correct`, () => {
    ...
    beforeEach(() => {
      ...
      cy.login()
        .visit(`/learn`)
        .wait("@languageHeadRequest");
      cy.get("textarea#learn-guess-input").type(guess);
      cy.get("form")
        .submit()
    ...
    it(`gives feedback the word was correct`, () => {
      ...
      Cypress.Promise.all([
        ...
        cy.get("main").within($main => {
          ...
          cy.get("h3").should("have.text", `Correct! :D`);
          cy.get("button").should("have.text", `Next word`);
        });
      });
    });
